...
import ChatRoomsScreen from "../Screens/HomeScreens/ChatRooms";
            ...
            {state.routes.map((route, index) => {
                ...
                return (
                    <Pressable
                        ...
                        {
                            label == "Discussion" ?
                                <CustomTabItem label="Discussions" />
                                : label == "ChatRoom" ? <CustomTabItem label="Chat Rooms" />
                                    : label == "Friends" ? <CustomTabItem label="Friends" />
                                        : label == "Account" ? <CustomTabItem label="Account" />
                                            : null
                        }
...
export function HomeScreens() {
    return (
        ...
        >
            ...
            <Tab.Screen name="ChatRoom" component={ChatRoomsScreen} />
